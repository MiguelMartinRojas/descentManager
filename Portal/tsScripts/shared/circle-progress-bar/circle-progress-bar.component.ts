...
export class CircleProgressComponent implements OnInit {
    ...
    private calculateAngle(r:any, rad:any) {
    ...
    private setArcSet(angle:any) {
        this.arcSweepNegative = this.createArgument(null, 0, 0);
    ...
    private animationLoop(i:any, time:any) {
        setTimeout(()=> {
